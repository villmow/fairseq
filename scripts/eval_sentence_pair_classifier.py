...
def eval_dataset(task, model, dataset, out_file, labels, thresholds, compute_metrics, use_cuda=True):
...
def main(parsed_args):
    ...
    eval_dataset(task, model, task.dataset(args.gen_subset), args.out_file, args.labels, args.thresholds,
